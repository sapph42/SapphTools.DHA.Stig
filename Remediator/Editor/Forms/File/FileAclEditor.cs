...
public partial class FileAclEditor : Form {
    ...
    private static Ace? EditAce(Ace? ace) {
        FileAceEditor aceEditor = new(ace);
    ...
    private static void UpdateRow(DataGridViewRow row, Ace ace, bool overwrite = false) {
        ...
        row.Cells["AppliesToDgv"].Value = ace.Flags switch {
            null => "This folder only",
            SddlAceFlags.SDDL_CONTAINER_INHERIT | SddlAceFlags.SDDL_OBJECT_INHERIT => "This folder, subfolders and files",
            SddlAceFlags.SDDL_CONTAINER_INHERIT => "This folder and subfolders",
            SddlAceFlags.SDDL_OBJECT_INHERIT => "This folder and files",
            SddlAceFlags.SDDL_CONTAINER_INHERIT | SddlAceFlags.SDDL_OBJECT_INHERIT | SddlAceFlags.SDDL_INHERIT_ONLY => "Subfolders and files only",
            SddlAceFlags.SDDL_CONTAINER_INHERIT | SddlAceFlags.SDDL_INHERIT_ONLY => "Subfolders only",
            SddlAceFlags.SDDL_OBJECT_INHERIT | SddlAceFlags.SDDL_INHERIT_ONLY => "Files only",
            _ => "Unknown"
        };
        row.Tag = ace;
    }
